  ...
  getVenues() {
    ...
    if (this.recipeValue !== null) {
      this._http.get('https://api.edamam.com/search?q=' + this.recipeValue +
        '&app_id=90345b31&app_key=7884f37e59a7ff7d16ceb275bec553a9&from=0&to=3')
        .subscribe((data: any) => {
    ...
    if (this.recipeValue != null && this.recipeValue !== '') {
      this._http.get('https://api.foursquare.com/v2/venues/search' +
        '?client_id=G5OO4KGXWZH5HP4SVGYRYPU2WASGICGWEFERO1OENGDDJOCM' +
        '&client_secret=LLY5DKHOR1CJ4VUXB1UOUT4KFNIYMHBV33XTU5S5WWVYTXDI' +
        '&v=20160215&limit=5' +
        // If user leaves place field empty, use their geolocation data
        (!this.placeValue || this.placeValue.toLowerCase() === 'near me'
